export function AddressDetails({ formData, setformData }) {
  ...
  const stateDistricts = {
    ...
    "Maharashtra": [
      ...
      "Nagpur", "Nanded", "Nashik", "Osmanabad", "Palghar", "Parbhani", 
  ...
  // Get all state names
  const getAllStates = () => {
    return Object.keys(stateDistricts).sort();
  };
        ...
        <div class="form-grid">
          <div class="form-group">
            ...
            <select 
              ...
              onChange={e => {
                handleInputChange('presentState', e.target.value);
                // Reset district when state changes
                handleInputChange('presentDistrict', '');
                handleInputChange('presentTaluka', '');
              }}
            >
          ...
          <div class="form-group">
            ...
            >
              ...
              {formData.presentState && getDistrictsForState(formData.presentState).map(district => (
